...
public static void main(String[] args) {
	...
	StaticInstanceVariable orderInst = new StaticInstanceVariable();
	
	//Assigning to static variable and Accessing by classname.staticvaraiblename
	StaticInstanceVariable.countOfOrders = 10;
	System.out.println(StaticInstanceVariable.countOfOrders);
